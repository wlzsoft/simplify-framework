...
import vip.simplify.mvc.invoke.MethodSelector;
...
public class MethodSelectorInterfaceHandler implements IInterfaceHandler {
	...
	@Override
	public Class<?> handle() {
		List<Class<?>> methodSelectorList = ClassUtil.findClassesByInterfaces(IMethodSelector.class, BeanAnnotationResolver.getClasspaths());
