		...
		if (modelClassPath != null) {
			...
			for (String cpath : classPathArr) {
				...
				try {
					...
					Class<Annotation> entityClassTemp = (Class<Annotation>) Class.forName("vip.simplify.entity.annotations.Entity");
...
//						methodArr = modelClass.getDeclaredMethods();
	 ...
	 * 方法用途: TODO<br>
	 * 操作步骤: TODO<br>
	 * @param args vip.simplify.demo.mvc.model,vip.simplify.demo.mvc.entity 多个参数用逗号隔开
	 */
