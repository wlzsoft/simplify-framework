 ...
 * <p>Desc: java命令启用的参数： -javaagent:E:/workspace-git/simplify-framework/weaving/target/weaving-{version}.jar -Daop.properties=E:/workspace-git/simplify-framework/aop/src/main/resources/aop.properties</p>
...
//    	一.配置读取
	...
	private void embedMethod(ClassPool pool, String className, CtMethod ctmethod)
		...
		builder.append("ir = new vip.simplify.aop.InterceptResult();")
			   .append("beforeObject = vip.simplify.aop.IInterceptor.initBefore(\""+methodFullName+"\",ir,this,$args);");
