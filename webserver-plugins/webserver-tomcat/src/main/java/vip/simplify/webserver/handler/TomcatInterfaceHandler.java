...
import vip.simplify.webserver.TomcatTaskFactory;

/**
  * <p><b>Title:</b><i>tomcat的实现类选择器</i></p>
 * <p>Desc: TODO</p>
...
public class TomcatInterfaceHandler implements IInterfaceHandler {

	@Override
	public Class<?> handle() {
		return TomcatTaskFactory.class;
	}
