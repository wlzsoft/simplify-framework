...
* <p>Desc: 解决类似：attempted  duplicate class definition for name: "vip/simplify/xxx" 的问题 </p>
...
//	private static ByteCodeClassLoader byteCodeClassLoader = new ByteCodeClassLoader(ClassLoader.getSystemClassLoader());
	 ...
	 * 操作步骤: TODO<br>
	 * @param classFileName 
	 * @throws java.lang.LinkageError: loader (instance of  vip/simplify/classload/XXXClassLoader): attempted  duplicate class definition for name:"vip/simplify/xxx"
	 */
