...
* <p>Desc: 1.只需要一个classloader实例，可以重复载入同名类而不会报异常：java.lang.LinkageError: loader (instance of  com/meizu/simplify/classload/XXXClassLoader): attempted  duplicate class definition for name:"com/meizu/xxx"
