 ...
 *
 */
public class SetCacheDao extends RedisCacheDao {
	private static final Logger log = LoggerFactory.getLogger(SetCacheDao.class);
    public SetCacheDao(String mod_name) {
		super(mod_name);
	}
