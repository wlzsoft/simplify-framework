 ...
 * String 结构操作
 */
public class StringCacheDao extends RedisCacheDao {
	private static final Logger log = LoggerFactory
			.getLogger(StringCacheDao.class);

	public StringCacheDao(String mod_name) {
		super(mod_name);
	}

	public static void main(String[] args) {
		StringCacheDao client = new StringCacheDao("redis_ref_hosts");
