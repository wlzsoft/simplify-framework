 ...
 * <p>Company:meizu</p>
 * <p>Create Date:2014年12月22日 下午2:29:13</p>
...
public class DateUtils {
	...
	public static final String FORMAT_6 = "yyyy-MM-dd HH:mm:ss SSS";
	
	private static SimpleDateFormat sdf = new SimpleDateFormat();
	public static SimpleDateFormat dateFormat = new SimpleDateFormat(FORMAT_1);
	public static SimpleDateFormat dateFormatDB = new SimpleDateFormat(FORMAT_3);// 数据库使用的日期格式
	public static SimpleDateFormat dateFormatMothDB = new SimpleDateFormat(FORMAT_5);// 数据库使用的日期格式
	public static SimpleDateFormat dataTimeFormat = new SimpleDateFormat(FORMAT_2);
...
//	}
	...
	public static void main(String[] args){
		System.out.println(getDisDays(new Date(), new Date()));
			Date d = new Date();
			System.out.println(getDateStr(getDistDate(d, -1)));
//	      Calendar c = Calendar.getInstance();
	        System.out.println(intervalTimeOfSecond("2011-12-05 19:59:00",""));
	}
