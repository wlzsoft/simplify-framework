...
import vip.simplify.encrypt.base64.Base64StreamDecoder;
import vip.simplify.encrypt.base64.Base64StreamEncoder;
import vip.simplify.encrypt.base64.Base64VariantEncrypt;
...
public class Base64EncryptTest {
	...
	public void base64Decoder() throws Exception {
		...
		if (args.length != 1) {
			System.err.println("Usage: java vip.simplify.encrypt.base64.Base64Decoder fileToDecode");
			return;
		}
//		InputStream is = new FileInputStream(args[0]);
	...
	public void base64Encoder() throws Exception {
		...
		if (args.length != 1) {
			System.err.println("Usage: java vip.simplify.encrypt.base64.Base64Encoder fileToEncode");
			return;
		}
