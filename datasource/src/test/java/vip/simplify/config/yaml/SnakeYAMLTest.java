    ...
    public static void test2() {
        try {
            User c1 = new User("test1", 1, Arrays.asList(
                    new vip.simplify.config.yaml.Test("test1", "1"),
                    new vip.simplify.config.yaml.Test("test2", "2")));
            User c2 = new User("test2", 23, Arrays.asList(
                    new vip.simplify.config.yaml.Test("test1", "3"),
                    new vip.simplify.config.yaml.Test("test2", "4")));
