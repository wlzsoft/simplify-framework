#!/bin/bash
echo "./service.sh stop  config-server 1.2.1 deamon debug 10.2.67.28"
echo "./service.sh start config-server 1.2.1 no no 10.2.67.28"
echo "./service.sh start config-server 1.2.1"
